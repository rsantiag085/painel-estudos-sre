...
Período: 25/05/2026 a 31/12/2026 — S05–S36 (início real: segunda-feira 25/05)

Regras da escala:
  Dia ÍMPAR  → FOLGA  → 4h estudo: manhã 09–11h (2h) + tarde 14–16h (2h)
  Dia PAR    → TRABALHO → 0.5h passivo (podcast/revisão)

Lesson ID: "{YYYY-MM-DD}-{idx}"  ex: "2026-05-25-0"
"""
...
WEEKS = {
    ...
    5: {
        ...
        "dates": {
            ...
            "2026-05-30": {"type": "T", "lessons": [
                _p("Podcast 'Command Line Heroes' — história do Linux"),
            ]},
            "2026-05-31": {"type": "F", "lessons": [
    ...
    6: {
        ...
        "dates": {
            ...
            "2026-06-04": {"type": "T", "lessons": [
                _p("Podcast 'Command Line Heroes' — shell scripting"),
            ]},
            "2026-06-05": {"type": "F", "lessons": [
    ...
    8: {
        ...
        "dates": {
            ...
            "2026-06-19": {"type": "F", "lessons": [
                ...
                _r("Buffer Fase 1 — reforçar pontos fracos identificados", 2, "tarde"),
            ]},
    ...
    10: {
        ...
        "dates": {
            ...
            "2026-07-03": {"type": "F", "lessons": [
                ...
                _b("Automate the Boring Stuff — Caps 5-6: dicts, manipulação de strings", 2, "tarde"),
            ]},
    ...
    15: {
        ...
        "dates": {
            ...
            "2026-08-04": {"type": "T", "lessons": [
                _p("Podcast 'AWS re:Invent' — observabilidade na AWS"),
            ]},
            "2026-08-05": {"type": "F", "lessons": [
            ...
            "2026-08-06": {"type": "T", "lessons": [
                _p("Flashcards AWS — segurança e compliance"),
            ]},
            "2026-08-07": {"type": "F", "lessons": [
    ...
    19: {
        ...
        "dates": {
            ...
            "2026-09-02": {"type": "T", "lessons": [
                _p("Podcast 'Ansible automates' — playbooks e roles"),
            ]},
            "2026-09-03": {"type": "F", "lessons": [
            ...
            "2026-09-04": {"type": "T", "lessons": [
                _p("Podcast 'Ansible automates' — inventários dinâmicos"),
            ]},
            "2026-09-05": {"type": "F", "lessons": [
